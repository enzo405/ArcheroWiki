# Generated by Django 4.1.6 on 2023-05-23 07:35
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('dragon1_type', models.CharField(choices=[('None', 'None'), ('Glacion', 'Glacion'), ('Infernox', 'Infernox'), ('Stormra', 'Stormra'), ('Noxion', 'Noxion'), ('Shadex', 'Shadex'), ('Jadeon', 'Jadeon'), ('Dominus', 'Dominus'), ('Ferron', 'Ferron'), ('Geogon', 'Geogon'), ('Swordian', 'Swordian'), ('Necrogon', 'Necrogon'), ('Starrite', 'Starrite'), ('Voideon', 'Voideon'), ('Magmar', 'Magmar')], default='Glacion', max_length=30)),
                ('dragon2_type', models.CharField(choices=[('None', 'None'), ('Glacion', 'Glacion'), ('Infernox', 'Infernox'), ('Stormra', 'Stormra'), ('Noxion', 'Noxion'), ('Shadex', 'Shadex'), ('Jadeon', 'Jadeon'), ('Dominus', 'Dominus'), ('Ferron', 'Ferron'), ('Geogon', 'Geogon'), ('Swordian', 'Swordian'), ('Necrogon', 'Necrogon'), ('Starrite', 'Starrite'), ('Voideon', 'Voideon'), ('Magmar', 'Magmar')], default='Infernox', max_length=30)),
                ('dragon3_type', models.CharField(choices=[('None', 'None'), ('Glacion', 'Glacion'), ('Infernox', 'Infernox'), ('Stormra', 'Stormra'), ('Noxion', 'Noxion'), ('Shadex', 'Shadex'), ('Jadeon', 'Jadeon'), ('Dominus', 'Dominus'), ('Ferron', 'Ferron'), ('Geogon', 'Geogon'), ('Swordian', 'Swordian'), ('Necrogon', 'Necrogon'), ('Starrite', 'Starrite'), ('Voideon', 'Voideon'), ('Magmar', 'Magmar')], default='Stormra', max_length=30)),
