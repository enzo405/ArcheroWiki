# Generated by Django 4.1.6 on 2023-07-29 13:17
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image_label', models.CharField(blank=True, default=None, max_length=255, null=True, validators=[django.core.validators.RegexValidator('([-\\w]+\\.(?:png))', 'Your string be an image.')])),
                ('last_change', models.CharField(default='Created on 07/29/2023', max_length=55)),
                ('is_new', models.BooleanField(default=True)),
                ('display', models.BooleanField(default=True)),
                ('index', models.IntegerField(blank=True, null=True)),
                ('titre_description', models.CharField(blank=True, default=None, max_length=255, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('strength_level', models.IntegerField(default=0, validators=[django.core.validators.MaxValueValidator(25)])),
                ('power_level', models.IntegerField(default=0, validators=[django.core.validators.MaxValueValidator(25)])),
                ('recover_level', models.IntegerField(default=0, validators=[django.core.validators.MaxValueValidator(25)])),
                ('block_level', models.IntegerField(default=0, validators=[django.core.validators.MaxValueValidator(25)])),
                ('iron_bulwark_level', models.IntegerField(default=0, validators=[django.core.validators.MaxValueValidator(25)])),
                ('enhanced_equipment_level', models.IntegerField(default=0, validators=[django.core.validators.MaxValueValidator(10)])),
                ('hero_power_up_level', models.IntegerField(default=0, validators=[django.core.validators.MaxValueValidator(10)])),
                ('runes_power_up_level', models.IntegerField(default=0, validators=[django.core.validators.MaxValueValidator(15)])),
                ('user_profile', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='calculator.user')),
            ],
            bases=(models.Model, calculator.models.parentModel),
        ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('dragon1_type', models.CharField(choices=[('None', 'None'), ('Glacion', 'Glacion'), ('Infernox', 'Infernox'), ('Stormra', 'Stormra'), ('Noxion', 'Noxion'), ('Shadex', 'Shadex'), ('Jadeon', 'Jadeon'), ('Dominus', 'Dominus'), ('Ferron', 'Ferron'), ('Geogon', 'Geogon'), ('Swordian', 'Swordian'), ('Necrogon', 'Necrogon'), ('Starrite', 'Starrite'), ('Voideon', 'Voideon'), ('Magmar', 'Magmar')], default='None', max_length=30)),
                ('dragon2_type', models.CharField(choices=[('None', 'None'), ('Glacion', 'Glacion'), ('Infernox', 'Infernox'), ('Stormra', 'Stormra'), ('Noxion', 'Noxion'), ('Shadex', 'Shadex'), ('Jadeon', 'Jadeon'), ('Dominus', 'Dominus'), ('Ferron', 'Ferron'), ('Geogon', 'Geogon'), ('Swordian', 'Swordian'), ('Necrogon', 'Necrogon'), ('Starrite', 'Starrite'), ('Voideon', 'Voideon'), ('Magmar', 'Magmar')], default='None', max_length=30)),
                ('dragon3_type', models.CharField(choices=[('None', 'None'), ('Glacion', 'Glacion'), ('Infernox', 'Infernox'), ('Stormra', 'Stormra'), ('Noxion', 'Noxion'), ('Shadex', 'Shadex'), ('Jadeon', 'Jadeon'), ('Dominus', 'Dominus'), ('Ferron', 'Ferron'), ('Geogon', 'Geogon'), ('Swordian', 'Swordian'), ('Necrogon', 'Necrogon'), ('Starrite', 'Starrite'), ('Voideon', 'Voideon'), ('Magmar', 'Magmar')], default='None', max_length=30)),
                ...
                ('dragon1_level', models.IntegerField(default=0, validators=[django.core.validators.MinValueValidator(0), django.core.validators.MaxValueValidator(120)])),
                ('dragon2_level', models.IntegerField(default=0, validators=[django.core.validators.MinValueValidator(0), django.core.validators.MaxValueValidator(120)])),
                ('dragon3_level', models.IntegerField(default=0, validators=[django.core.validators.MinValueValidator(0), django.core.validators.MaxValueValidator(120)])),
