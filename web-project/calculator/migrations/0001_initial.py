# Generated by Django 4.1.2 on 2023-03-18 15:36
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('reward_1_type', models.CharField(choices=[('none', 'none'), ('gem', 'gem'), ('celestite_keys', 'celestite_keys'), ('purple_ticket', 'purple_ticket'), ('premium_ticket', 'premium_ticket'), ('gold', 'gold'), ('random_shards', 'random_shards'), ('obsidian_keys', 'obsidian_keys'), ('energy', 'energy')], default=' ', max_length=20)),
                ('reward_1_amount', models.CharField(blank=True, default=' ', max_length=10, null=True)),
                ('reward_2_type', models.CharField(choices=[('none', 'none'), ('gem', 'gem'), ('celestite_keys', 'celestite_keys'), ('purple_ticket', 'purple_ticket'), ('premium_ticket', 'premium_ticket'), ('gold', 'gold'), ('random_shards', 'random_shards'), ('obsidian_keys', 'obsidian_keys'), ('energy', 'energy')], default=' ', max_length=20)),
                ('reward_2_amount', models.CharField(blank=True, default=' ', max_length=10, null=True)),
                ('reward_3_type', models.CharField(choices=[('none', 'none'), ('gem', 'gem'), ('celestite_keys', 'celestite_keys'), ('purple_ticket', 'purple_ticket'), ('premium_ticket', 'premium_ticket'), ('gold', 'gold'), ('random_shards', 'random_shards'), ('obsidian_keys', 'obsidian_keys'), ('energy', 'energy')], default=' ', max_length=20)),
                ('reward_3_amount', models.CharField(blank=True, default=' ', max_length=10, null=True)),
                ('reward_4_type', models.CharField(choices=[('none', 'none'), ('gem', 'gem'), ('celestite_keys', 'celestite_keys'), ('purple_ticket', 'purple_ticket'), ('premium_ticket', 'premium_ticket'), ('gold', 'gold'), ('random_shards', 'random_shards'), ('obsidian_keys', 'obsidian_keys'), ('energy', 'energy')], default=' ', max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('skin_health', models.IntegerField(default=0, validators=[django.core.validators.MaxValueValidator(11995)])),
                ('skin_attack', models.IntegerField(default=0, validators=[django.core.validators.MaxValueValidator(2560)])),
                ('user_profile', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='calculator.user')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('weapon_coeff', models.FloatField(default=1)),
